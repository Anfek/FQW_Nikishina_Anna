...
int main() {
    try {
        std::ifstream inputFile("./data/analysis_results128_spectral.csv");
        std::ofstream outputFile("./data/processed_spectral_analysis128.csv");
        ...
        std::cout << "Предобработка завершена, результат сохранён в ./data/processed_spectral_analysis128.csv" << std::endl;
