...
# Загрузка данных
data = pd.read_csv('./data/processed_spectral_analysis128.csv')
...
# Сохранение графика
#plt.savefig("./data/averaged_analysis_spectral128.png")
plt.savefig("./picture128/averaged_analysis_spectral128.png")
